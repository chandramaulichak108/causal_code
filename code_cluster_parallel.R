...
tic()
# cuPC_fit <- cu_pc(suffStat, indepTest = disCItest, alpha = 0.05, labels = V, verbose = TRUE)
cuPC_fit <- pc_parallel(suffStat, indepTest = disCItest, alpha = alpha_d, labels = V, verbose = TRUE,num.co=20)
